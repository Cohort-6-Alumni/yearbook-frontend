...
const CustomCard = ({ bio,previousField,hobbies,instagram, firstName, lastName,picture,id }) => {
  ...
  return (
    <div className="max-w-sm mx-auto bg-white border border-gray-200 rounded-lg shadow-md p-4 cursor-pointer" onClick={handleClick} >
